...
export const Home = () => {
    return(
        ...
        <div className="main_lay">
          <div className="left">
              <img className="logo_valhalla" src="https://github.com/sailuchandragiri/sailuchandragiri/blob/main/Project/logo.png?raw=true"></img>
          </div>
          <div className="right">
              <div className="up">
                  <div className="insta_title"></div>
                  <Box>
                      <TextField  className="phonenumber" margin="dense" variant="outlined" label="Phonenumber, username or email"/>
                  </Box>
                  <Box>
              ...
              <div className="down">
                  ...
                  <div className="siup">Sign up</div>
              </div>
